    ...
    return (
      <Component
        ...
        className={cn(
          ...
          } transition-colors text-text border border-transparent font-medium rounded-lg shadow-sm focus:outline-none disabled:bg-disabled disabled:text-neutral-400 disabled:cursor-not-allowed`,
          fit && "w-fit",
