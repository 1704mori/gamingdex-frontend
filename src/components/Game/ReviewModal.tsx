...
export default function ReviewModal({
  ...
  return (
    <Modal
      ...
      className="max-h-[400px] lg:max-h-[700px] overflow-y-auto !rounded-none !bg-background"
      modalOpen={reviewModalOpen}
      handleClose={closeReviewModal}
      floatingTop={
        <div className="flex flex-col lg:flex-row items-center self-start bg-background rounded-lg rounded-b-none w-full mb-1 p-2">
      ...
      floatingBottom={
        <div className="flex flex-col items-center justify-center bg-background rounded-lg rounded-t-none w-full mt-1 p-2">
